...
A command-line tool that automatically organizes messy folders. Reads all directory contents one by one and changes the file path to an appropriate folder based on the file extension.
...
Preview mode: 
 ...
 Input: ./organizer --preview /mnt/c/test_folder
 
 Output: Preview: /mnt/c/test_folder
...
Organize mode:
 ...
 Input: ./organizer /mnt/c/test_folder

 Output: Organizing: /mnt/c/test_folder
          app.cpp -> /mnt/c/test_folder/Code
          audio.wav -> /mnt/c/test_folder/Music
          budget.xls -> /mnt/c/test_folder/Documents
          clip.mp4 -> /mnt/c/test_folder/Videos
